<nav x-data="{ open: false }" class="bg-white  border-gray-100 py-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:space-x-4">
                ...
                @endphp
                <x-notification-button :unreadCount="$unreadCount" />
                <!-- Settings Dropdown -->
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 0 bg-white  hover:text-gray-700  focus:outline-none transition ease-in-out duration-150">
                            <div class="flex items-center gap-2">
                                ...
                                <div class="hidden sm:block">
                                    ...
                                    <div class="text-xs text-gray-500">Head Engineer</div>
                                </div>
                            </div>
